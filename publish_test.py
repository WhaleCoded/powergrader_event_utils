...
def create_org_worth_of_events():
    ...
    apporto_test_event = OrganizationEvent(name="Apporto Test", code=str(uuid4()))
    ...
    sub_files = SubmissionFilesEvent(
        student_id=student.public_id, file_content=[file_obj]
    )
